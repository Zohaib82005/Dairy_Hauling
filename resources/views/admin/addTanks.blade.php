...
<body class="">
    <h5 class="text-center bg-dark p-1 text-white">Add Tanks of Farms</h5>
    @if ($errors->any())
    @foreach ($errors->all() as $error)
            <div class="alert alert-danger">{{$error}}</div>
        @endforeach
    @endif
    <form action="{{ route('admin.insert.tank') }}" method="POST" class="m-5 p-5 border shadow-lg">
        @csrf
        <div class="row">
            ...
            <div class="col-12">
             ...
             <div class="col-12">
                <div class="form-floating">
                    <input type="text" step="any" name="tank_id" id="tid" class="form-control my-2">
            ...
            <div class="col-12">
                <div class="form-floating">
                    <select name="type" id="type" onclick="toShow()"  class="form-control my-2">
                        <option selected disabled>--Select Type Of Tank--</option>
            ...
            <div class="col-12">
                <div class="form-floating">
                    <input type="number" step="any" name="height" id="height" class="form-control my-2">
                    <label for="height">Enter Height of Tank</label>
                </div>
            </div>
            <div class="col-12" id="toShowWidth">
                <div class="form-floating">
                    <input type="number" step="any" name="width" id="Width" class="form-control my-2">
                    <label for="Width">Enter Width of Tank</label>
                </div>
            </div>
            <div class="col-12" id="toShowRadius">
                <div class="form-floating">
                    <input type="number" step="any" name="radius" id="radius" class="form-control my-2">
                    <label for="radius">Enter Radius of Tank</label>
                </div>
            </div>
            <div class="col-12" id="toShowLength">
                <div class="form-floating">
                    <input type="number" step="any" name="length" id="length" class="form-control my-2">
