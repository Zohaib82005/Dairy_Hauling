...
<body>
    ...
    <div class="container">
        ...
        <a href="{{ route('user.complete.profile',Auth::user()->id) }}" class="btn btn-success my-2">Complete Profile</a>
        </div>
    </div>
    @endif
        ...
        <div class="row">
            ...
            <div class="col-lg-6  shadow-lg p-4 text-center rounded">
                <div class="" onclick="showTicketAlert()">
                    ...
                    <a href="{{ route('getTicket') }}" id="ticket" class="btn btn-success rounded p-2 mt-1 ">Get Ticket</a>
                 </div >
