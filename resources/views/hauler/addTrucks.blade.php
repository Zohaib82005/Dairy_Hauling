...
<body class="">
    ...
    @foreach ($errors->all() as $error)
        ...
        @endforeach
    @endif
    <form action="{{ route('hauler.insert.truck') }}" method="POST" class="m-5 p-5 border shadow-lg">
        @csrf
        <div class="row">

            <div class="col-12">
                <div class="form-floating">
                    <input type="text" name="truck_id" required class="form-control my-2" id="truck_id" placeholder="Enter Truck ID">
            ...
            <div class="col-12">
                <div class="form-floating text-center">
                    <button type="submit" class=" btn btn-primary m-2 p-2 px-5" >Add Truck</button>
                </div>
            </div>
