        ...
        <div class="container">
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <h3 class="mb-4">Verify Email Here</h3>
                     @if (isset($error))
                        <div class="alert alert-danger">{{$error}}</p>
                    @endif
                    <p>An email has been sent to you. Please verify your email Address</p>
                    <form method="POST" action="{{ route('verify.email') }}">
                        @csrf
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="number" class="form-control" name="otp" id="name" placeholder="Please Enter OTP">
