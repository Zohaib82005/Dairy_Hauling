...
<form action="{{ route('collect.at.plant',$ticketID) }}" method="POST" id="tankReading" class="">
    @csrf
...
<button type="submit" onclick="clearStorage()" class="btn btn-success my-2">Submit</button>
    </div>
