...
<body>
            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-light m-0">
                        <a href="" class="dropdown-item active">Sign Up</a>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white mb-4 animated slideInDown">Sign Up</h1>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <a class="btn btn-secondary rounded-pill py-3 px-5 mt-3" href="">Start Now</a>
                </div>
                <div class="col-lg-6">
                    @if ($errors->any())
<ul>
                         ...
                         <div class="col-12 ">
                            ...
                            <div class="col-12">
                                <div class="form-floating text-center">
                                    <button type="submit" class=" btn m-2 p-2 px-5" style="background-color:#EDDD5E;">Sign Up</button>
                                </div>
                            </div>
                            <div class="col-12 text-center">
                                <p>Already have an acoount? <a href="{{ route('user.login') }}" style="color:blue;">Login Now</a></p>
                            </div>
                        </div>
                     </form>
                    </div>
