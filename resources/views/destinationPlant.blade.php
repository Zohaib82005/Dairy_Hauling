...
<body>
    ...
    <div class="container p-2">
        <h4 class="bg-success text-white text-center p-2">Destination Plant</h4>
        <h5>Plant Name: {{ $destinationPlant->name }} </h5>
        <h5>Route Number: {{$destinationPlant->route_number}}</h5>
        @if ($errors->any())
            ...
            @endforeach
        @endif
        <form action="{{ route('collect.at.plant',$ticketID) }}" method="POST" class="" onsubmit="clearStorage()">
         @csrf
            <div class="row">
                <div class="col-12 my-2">
                    <div class="form-floating ">
                        <input type="number" class="form-control" step="any" required name="temprature" id="temprature">
                        <label for="temprature" class="form-label">Temprature of Milk</label>
                    </div>
                </div>
                <div class="col-12 my-2"  id="tankReading">
                    <div class="form-floating">
                        <input type="number" name="collected_milk"  id="cm" class="form-control">
                        <label for="cm">Enter The Milk Reading At Plant in Pounds</label>
                    </div>
                </div>
                <div class="col-12 text-center">
                    <button type="submit" class="btn btn-success my-2">Close Route</button>
                </div>
            </div>
        </form>
    </div>
