        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100 h-100" src="{{ asset('images/carousel-1.jpg')}}" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-8 text-start">
                                    <p class="fs-4 text-white">Welcome to Milk Hauling</p>
                                    <h1 class="display-1 text-white mb-5 animated slideInRight">Collect Milk from Dairy Farms</h1>
                                    <a href="{{ route('user.dashboard') }}" class="btn btn-secondary rounded-pill py-3 px-5 animated slideInRight">Start now</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="carousel-item">
                    <img class="w-100 " height="700" src="{{ asset('images/carousel-2.jpg')}}" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-end">
                                <div class="col-lg-8 text-end">
                                    <p class="fs-4 text-white">Welcome to Milk Hauling</p>
                                    <h1 class="display-1 text-white mb-5 animated slideInRight">Best Trucks and Tanks to Haul</h1>
                                    <a href="{{ route('user.dashboard') }}" class="btn btn-secondary rounded-pill py-3 px-5 animated slideInLeft">Start Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row g-5 align-items-end">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <h1 class="mb-4">Know About Our Dairy Farm Hauling & Our History</h1>
                    <p class="mb-4">Our Company provides the people an opportunity to find jobs. With us people collect milk from different farms and inform us about the every milk pickup locations.</p>
                    <div class="row g-5 pt-2 mb-5">
                        <div class="col-sm-6">
                            <img class="img-fluid mb-4" src="img/service.png" alt="">
                            <h5 class="mb-3">Dedicated Services</h5>
                            <span>We want dedicated people to work with us.</span>
                        </div>
                        
                    </div>
                    <a class="btn btn-secondary rounded-pill py-3 px-5" href="{{ route('user.dashboard') }}">Start Now</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p class="mb-4">It's an honor for us that people are choosing us because we provide the great opportunities to our dedicated drivers that include the following:</p>
                    <p><i class="fa fa-check text-primary me-3"></i>High Income Salary</p>
                    <p><i class="fa fa-check text-primary me-3"></i>Profit based on their work</p>
                    <p><i class="fa fa-check text-primary me-3"></i>Annual ceremony dinner</p>
                    <p>It's an honor for us and We will be very happy if you work with us.</p>
                    <a class="btn btn-secondary rounded-pill py-3 px-5 mt-3" href="{{ route('user.dashboard') }}">Start Now</a>
                </div>
                <div class="col-lg-6">
                        ...
                        <div class="row g-0">
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.1s">
                                <div class="text-center bg-primary py-5 px-4">
                                    ...
                                    <h1 class="display-6 text-white" data-toggle="counter-up">12</h1>
                            ...
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.5s">
                                <div class="text-center bg-secondary py-5 px-4">
                                    ...
                                    <h1 class="display-6" data-toggle="counter-up">300</h1>
                                    <span class="fs-5 fw-semi-bold text-primary">Total Haulers/Truck</span>
                                </div>
                            </div>
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.7s">
                                <div class="text-center bg-primary py-5 px-4">
                                    <img class="img-fluid mb-4" src="img/client.png" alt="">
                                    <h1 class="display-6 text-white" data-toggle="counter-up">940</h1>
                                    <span class="fs-5 fw-semi-bold text-secondary">Happy Drivers</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto pb-4 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <h1 class="mb-5">Services That We Offer For Drivers</h1>
            </div>
                ...
                <div class="col-lg-4 col-md-6 pt-5 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item d-flex h-100">
                        ...
                        <div class="service-text p-5 pt-0">
                            ...
                            <h5 class="mb-3">Best Truck Selection</h4>
                            <p class="mb-4">We provide them the opportunity to choose truck of their own. If they can't we provide them the best trucks of country.</p>
                            <a class="btn btn-square rounded-circle" href="{{ route('user.dashboard') }}"><i class="bi bi-chevron-double-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 pt-5 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item d-flex h-100">
                        ...
                        <div class="service-text p-5 pt-0">
                            ...
                            <h5 class="mb-3">Monthly Profits</h5>
                            <p class="mb-4">Our worthy drivers are very hardworking and we also give them monthly profits based on their work.</p>
                ...
                <div class="col-lg-4 col-md-6 pt-5 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item d-flex h-100">
                        ...
                        <div class="service-text p-5 pt-0">
                            ...
                            <h5 class="mb-3">Health Care</h5>
                            <p class="mb-4">The health of our drivers is our first priority. In this sense we have special trained doctor for their checkups.</p>
                            <a class="btn btn-square rounded-circle" href=""><i class="bi bi-chevron-double-right"></i></a>
                        </div>
                    </div>
                </div>
