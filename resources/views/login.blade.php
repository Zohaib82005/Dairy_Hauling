                        ...
                        <div class="row">                         
                            <div class="col-12">
                             ...
                             <div class="col-12">
                                ...
                                <a href="{{ route('forget.password') }}" style="color: blue;">Forget Password?</a>
                            </div>
                             
                            <div class="col-12">
                                <div class="form-floating text-center">
                                    <button type="submit" class=" btn m-2 p-2 px-5" style="background-color:#EDDD5E;">Login</button>
                                </div>
                            </div>
                            <div class="col-12 text-center">
                                <p>Don't have an Account? <a href="{{ route('signup') }}" style="text-decoration: none; color:blue;">Register Now</a></p> 
                            </div>
                        </div>
                     </form>
                    </div>
