...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white mb-4 animated slideInDown">Reset Password</h1>
                        ...
                        <div class="row">                         
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="password" required name="password" class="form-control my-2" id="username" placeholder="Choose Unique Username">
                             ...
                             <div class="col-12">
                                <div class="form-floating">
                                    <input type="password" required name="password_confirmation" class="form-control my-2" id="password" placeholder="password">
                            ...
                            <div class="col-12">
                                <div class="form-floating text-center">
                                    <button type="submit" class=" btn m-2 p-2 px-5" style="background-color:#EDDD5E;">Update Password</button>
                                </div>
                            </div>
