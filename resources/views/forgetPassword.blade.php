...
<div class="alert alert-danger">{{session('mess')}} </div> 
        @endif
    <div class="text-center m-3 my-5 p-5">
        <p>Please write the email with which you have created your account. We will send a link to that where you can reset your password.</p>
        <form action="{{ route('send.link') }}" method="POST">
            ...
            <div class="col-lg-4">
                                <div class="form-floating">
                                    <input type="email" name="email" class="form-control my-2" id="email" placeholder="Choose Unique Username">
                                    <label for="email">Email</label>
                                </div>
                            </div>
                            <div class="col-lg-4"></div>
            </div>
            <button type="submit" class="btn btn-success rounded ">Send Link</button>
        </form>
    </div>
